...
if user_action == 1:
    ...
    # Cast img_w and img_h to integers
    img_w = int(img_w)
    img_h = int(img_h)
...
# If the user cancels, set default resolution
...
ax.set_title("Mandelbrot Fractal Visualization", fontsize=24)  # Add title here
fig.canvas.manager.window.title("Mandelbrot Fractal Visualization")  # Set the window title
